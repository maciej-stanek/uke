...
\marginnote{
	%\includegraphics[width=\marginparwidth]{chords/F\string##.png}
	\includegraphics[width=\marginparwidth]{chords/F.png}
	\includegraphics[width=\marginparwidth]{chords/C.png}
